            ...
            <div class="container-fluid py-1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 ps-2 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">New Blog</li>
                    </ol>
                    <h6 class="text-white font-weight-bolder ms-2">Add New Blog</h6>
                </nav>
                                        ...
                                        <div class="col-12 mt-4">
                                            ...
                                            <div class="dropdown">
                                                <input type="text" class="form-control dropdown-toggle"
                                                    id="kategoriDropdown" data-bs-toggle="dropdown"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                ...
                                                <p>Congratulations! You have successfully published your blog.</p>
