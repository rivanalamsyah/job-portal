    ...
    <aside
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/profile-admin">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder text-white mb-0">Maxy Academy</h6>
                </nav>
                            ...
                            <div class="row gx-4">
                                <div class="col-auto">
                                    <div class="avatar avatar-xl position-relative">
                                        <img src="/img/icon.png" alt="profile_image"
                                            class="w-100 border-radius-lg shadow-sm">
                                    </div>
                                </div>
                                <div class="col-auto my-auto">
                                    <div class="h-100">
                                        <h5 class="mb-1">Maxy Academy</h5>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Company
                                                Name</label>
                                            <input class="form-control" type="text" value="Maxy Academy" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Company
                                                Email</label>
                                            <input class="form-control" type="email" value="maxyacademy@gmail.com"
                                                disabled>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text"
                                                value="Pakuwon Tower 26-J Jl. Casablanca Raya No.88 Jakarta Selatan"
                                                disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="DKI Jakarta" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Postal
                                                code</label>
                                            <input class="form-control" type="text" value="12960" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">About
                                                Company</label>
                                            <textarea class="form-control" id="example-text-input" rows="5" disabled>Maxy Academy is a company that focuses on training and developing digital and technology skills. They provide various intensive bootcamp programs which aim to prepare students and fresh graduates to meet the needs of modern industry. The programs offered cover various fields such as Backend, Frontend, UI/UX, Digital Marketing, Product Management, and Data Science.</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="admin-text-input" class="form-control-label">Username</label>
                                            <input class="form-control" type="text" value="Admin 1" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="password" id="admin-password-input"
                                                placeholder="Enter your password">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="confirm-password-input" class="form-control-label">Confirm
                                                Password</label>
