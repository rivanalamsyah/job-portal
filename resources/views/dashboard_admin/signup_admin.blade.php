...
<body class="">
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
            style="background-image: url('/img/background/background-admin.jpg'); background-position: top;">
            <span class="mask bg-gradient-dark opacity-6"></span>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Welcome!</h1>
                        <p class="text-lead text-white">Please use this form to log in to your admin dashboard. Enjoy
                            easy access and manage information more efficiently.</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <form role="form" id="registrationForm">
                                ...
                                <div class="text-center">
                                    <a id="submitBtn" class="btn bg-gradient-dark w-100 my-4 mb-2"
                                        href="/dashboard-admin">Sign up</a>
                                </div>
                                <p class="text-sm mt-3 mb-0">Already have an account? <a href="/signin-admin"
