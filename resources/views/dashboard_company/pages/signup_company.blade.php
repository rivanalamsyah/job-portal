        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navigation">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link me-2" href="/profile-company">
                            <i class="fa fa-user opacity-6  me-1"></i>
                            Profile
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link me-2" href="/signup-company">
                            <i class="fas fa-user-circle opacity-6  me-1"></i>
                            Sign Up
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link me-2" href="/signin-company">
                        ...
                        <div class="card-body">
                            <form role="form">
                                ...
                                <div class="text-center">
                                    <a class="btn bg-gradient-dark w-100 my-4 mb-2" href="dashboard-company">Sign up</a>
                                </div>
