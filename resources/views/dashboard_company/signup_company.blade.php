...
<body class="">
    ...
    <nav
        ...
        <div class="container">
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="/dashboard-company">
    ...
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
            style="background-image: url('/img/background/background-company.jpg'); background-position: top;">
            <span class="mask bg-gradient-dark opacity-6"></span>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Welcome!</h1>
                        <p class="text-lead text-white">Check out this awesome form to sign up or create a new account
                            on your dashboard for free. Join us now and find the best talent for your company!</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <form role="form" id="registrationForm">
                                ...
                                <div class="text-center">
                                    <a id="submitBtn" class="btn bg-gradient-dark w-100 my-4 mb-2"
                                        href="/dashboard-company">Sign up</a>
                                </div>
                                <p class="text-sm mt-3 mb-0">Already have an account? <a href="/signin-company"
