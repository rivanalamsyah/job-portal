        ...
        <div class="container-fluid mt-4">
            <div class="row">
                <div class="col-12 d-flex justify-content-start align-items-center">
                    <a href="/save-job" class="me-5" style="font-weight: bold; text-decoration: none;">
                        <i class="fas fa-bookmark"></i> Saved
                    </a>
                    <a href="applied-student" class="position-relative"
                ...
                <div class="col-12">
                        ...
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-8 col-md-8">
                                <div class="card-body">
                                    ...
                                    <span
                                        class="badge bg-success position-absolute top-0 end-0 mt-3 me-3">Applied</span>
                    ...
                    <div class="card mb-3">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-8 col-md-8">
                                <div class="card-body">
                                    <h1 class="text-lg mt-3 text-uppercase font-weight-bold">Data Engineer</h1>
                                    <span
                                        class="badge bg-success position-absolute top-0 end-0 mt-3 me-3">Applied</span>
                                    <h2 class="text-sm mb-3 font-weight-bold">PT Gojek Indonesia</h2>
                                    <p class="text-xs mb-3 font-weight-bold">
                                        <i class="fas fa-dollar-sign"></i> Rp 5000.000 - Rp 10.000.000
                                    </p>
                                    <p class="text-xs mb-3 font-weight-bold">
                    ...
                    <div class="card mb-3">
                        <div class="row no-gutters align-items-center">
                            <div class="col-4 col-md-2 ms-3 mt-3 mb-3 d-flex align-items-center justify-content-start">
                                <img src="img/logo_company/logo_pertamina.jpeg" alt="pertamina"
                                    style="max-width: 100%; height: auto; border-radius: 30px;">
                            </div>
                            <div class="col-8 col-md-8">
                                <div class="card-body">
                                    <h1 class="text-lg mt-3 text-uppercase font-weight-bold">Front-End Programmer</h1>
                                    <span
                                        class="badge bg-success position-absolute top-0 end-0 mt-3 me-3">Applied</span>
                                    <h2 class="text-sm mb-3 font-weight-bold">PT Pertamina</h2>
                                    <p class="text-xs mb-3 font-weight-bold">
                                        <i class="fas fa-dollar-sign"></i> Rp 5000.000 - Rp 10.000.000
                                    </p>
                                    <p class="text-xs mb-3 font-weight-bold">
                    ...
                    <a href="/job-listing-student" class="btn btn-primary mt-3 mb-3">Apply for more</a>
                </div>
            </div>
        </div>
    </main>
