...
<div class="col-xl-3 col-lg-3 col-md-4">
    ...
    <div class="job-category-listing mb-80">
        <!-- single one -->
        ...
        <div class="single-listing">
            ...
            <div class="select-Categories pt-80 pb-30">
                ...
                <label class="container">SMA/SMK
                    <input type="checkbox">
                    <span class="checkmark"></span>
                </label>
                <label class="container">D4/S1
                    <input type="checkbox" checked="checked active">
                    <span class="checkmark"></span>
                </label>
                <label class="container">S2-S3
                    <input type="checkbox">
                    <span class="checkmark"></span>
                </label>
            </div>
            ...
            <!-- select experience start -->
            <div class="select-Categories pt-30 pb-50">
                <div class="small-section-tittle2">
                    <h4>Experience</h4>
                </div>
                <label class="container">
                    < 1 Years <input type="checkbox">
                        <span class="checkmark"></span>
                </label>
        ...
        <div class="single-listing">
            ...
            <div class="select-Categories pb-50">
                ...
                <label class="container"> Rp 2 - 5 jt
                    <input type="checkbox">
                    <span class="checkmark"></span>
                </label>
                <label class="container">Rp 5 - 8 jt
                    <input type="checkbox" checked="checked active">
                    <span class="checkmark"></span>
                </label>
                <label class="container">Rp 8 - 12 jt
                    <input type="checkbox">
                    <span class="checkmark"></span>
                </label>
                <label class="container">Rp 12 - 15 jt
                    <input type="checkbox">
                    <span class="checkmark"></span>
                </label>
                <label class="container">Rp 15 - 20 jt
                    <input type="checkbox">
                    <span class="checkmark"></span>
                </label>
            </div>
