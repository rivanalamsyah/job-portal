    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                ...
                <ul class="navbar-nav" style="display: flex; align-items: center; margin-left:300px;">
                    <li class="nav-item">
                        <a class="nav-link" href="/profile" onclick="moveActiveLine(this)"><b
                                style="color: navy;">LMS</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/profile" onclick="moveActiveLine(this)">
                            <i class="bi bi-person-circle" style="font-size: 1.6em;"></i>
                        </a>
                    </li>
                </ul>
