...
<body class="">
    ...
    <nav
        ...
        <div class="container">
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="/dashboard-student">
            ...
            <div class="collapse navbar-collapse" id="navigation">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <input type="radio" id="student" name="toggle" checked>
                        <label for="student" class="student"><a class="nav-link me-2"
                                href="/signup-student">Student</a></label>
                        <input type="radio" id="company" name="toggle">
                        <label for="company" class="company"><a class="nav-link me-2"
                                href="/signup-company">Company</a></label>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
            style="background-image: url('/img/background/background-student.jpg'); background-position: top;">
            <span class="mask bg-gradient-dark opacity-6"></span>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Welcome!</h1>
                        <p class="text-lead text-white">Find the best bootcamp and your dream job opportunity at Maxy
                            Academy. Register now and start your career journey on the right foot!</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <form role="form" id="registrationForm">
                                ...
                                <div class="text-center">
                                    <a id="submitBtn" class="btn bg-gradient-dark w-100 my-4 mb-2"
                                        href="/student-login">Sign up</a>
                                </div>
                                <p class="text-sm mt-3 mb-0">Already have an account? <a href="/signin-student"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Set default checked radio and route
    ...
    <script>
        document.getElementById('submitBtn').addEventListener('click', function(event) {
            ...
            if (!email.includes('@')) {
                document.getElementById('emailError').textContent = 'Emails must contain @';
                isValid = false;
            }
            ...
            if (!passwordRegex.test(password)) {
                document.getElementById('passwordError').textContent =
                    'The password must be a combination of numbers and letters and a minimum of 8 characters';
                isValid = false;
            }
